...
public class StartDJIMission2 extends AsyncTask<ArrayList<Waypoint>, Void, Void> {
    ...
    public StartDJIMission2(float timeout, float speed, WaypointMissionHeadingMode mHeadingMode,
